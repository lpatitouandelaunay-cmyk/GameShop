...
set "BASEDIR=%~dp0"
set "INSTALL_DIR=%BASEDIR%installerGameShopV3.1"
...
set "INSTALLER_URL=https://raw.githubusercontent.com/lpatitouandelaunay-cmyk/GameShopconnect/main/GameShopInstallerV3.1__2.bat"

set "PAGE_FILE=%INSTALL_DIR%\connecterGameShop.html"
set "INSTALLER_FILE=%INSTALL_DIR%\GameShopInstallerV3.1__2.bat"
...
echo [INFO] Téléchargement du deuxième script GameShopInstallerV3.1__2.bat ...
